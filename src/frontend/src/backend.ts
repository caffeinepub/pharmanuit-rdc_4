...
export class Backend implements backendInterface {
    ...
    async getApprovedPharmacies(): Promise<Array<Pharmacy>> {
        if (this.processError) {
            try {
                const result = await this.actor.getApprovedPharmacies();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async togglePharmacyVisibility(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.togglePharmacyVisibility(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
